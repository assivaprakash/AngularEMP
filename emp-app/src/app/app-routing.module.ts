...
{path:'emplist', canActivate:[AuthGuard], loadChildren: () => import('./emp-dashboard/emp-dashboard.module').then(m => m.EmpDashboardModule) },
{path:'empdashboard/:id',canActivate:[AuthGuard],component:EmpDashboardComponent},
